package com.ubanillx.smartclassbackendcourse.mapper;
...
/**
* @author liulo
* @description 针对表【course_material(课程资料)】的数据库操作Mapper
* @createDate 2025-03-21 15:14:50
* @Entity com.ubanillx.smartclassbackendmodel.model.entity.CourseMaterial
*/
